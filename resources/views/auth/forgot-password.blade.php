        ...
        <div class="max-w-md w-full space-y-8 card-glow relative z-10">
            ...
            <div class="text-center">
                <div class="flex justify-center mb-4">
                    <div class="w-16 h-16 bg-gradient-orange rounded-2xl flex items-center justify-center shadow-xl mail-icon">
                ...
                <h2 class="text-3xl font-extrabold tracking-tight">
                    <span class="text-gradient-orange">Reset</span>
            ...
            <form method="POST" action="{{ route('password.email') }}" class="mt-8 space-y-6">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <x-input-label for="email" :value="__('Email Address')" class="text-sm font-bold text-orange-200 uppercase tracking-wider text-[11px]" />
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="email" 
                            class="block w-full pl-10 pr-3 py-3 border border-orange-500/30 rounded-xl bg-white/10 backdrop-blur-sm text-white placeholder-white/50 focus:border-orange-400 focus:ring focus:ring-orange-500/30 transition-all duration-200 input-focus-ring"
                            type="email" 
                            name="email" 
                            :value="old('email')" 
                ...
                <div class="text-center pt-2">
                    <a href="{{ route('login') }}" class="inline-flex items-center gap-1 text-xs font-semibold text-orange-300 hover:text-orange-200 transition-colors duration-200">
