        ...
        <div class="max-w-md w-full space-y-8 card-glow relative z-10">
            ...
            <div class="text-center">
                ...
                <h1 class="text-3xl font-extrabold tracking-tight text-white">
                    <span class="bg-gradient-to-r from-orange-200 to-yellow-200 bg-clip-text text-transparent">Reset</span>
            ...
            <div class="bg-orange-500/20 backdrop-blur-sm border border-orange-400/30 rounded-xl p-5">
                <div class="flex items-start gap-3">
                    ...
                    <div class="text-sm text-orange-200 font-medium leading-relaxed">
                        Masukkan email dan password baru Anda. Pastikan password kuat dan mudah diingat.
                    </div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('password.store') }}" class="mt-8 space-y-5">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <x-input-label for="password" :value="__('New Password')" class="text-xs font-black text-orange-200 uppercase tracking-wider" />
                        <div class="text-[10px] text-orange-300 font-semibold">
                            Min. 8 characters
                        </div>
                    </div>
