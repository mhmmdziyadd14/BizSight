            ...
            <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between border-b pb-6 border-orange-200/50 fade-in-up">
                    ...
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            <h1 class="text-3xl font-extrabold tracking-tight">
                                ...
                                <span class="text-navy-900">Decisions</span>
                            </h1>
                ...
                <div class="mt-4 md:mt-0 flex gap-3">
                    <div class="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-5 py-2.5 rounded-2xl shadow-sm border border-orange-200">
                        ...
                        <span class="text-[10px] font-black text-navy-700 uppercase tracking-widest">Live Data</span>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mb-8 fade-in-up">
                <div class="stat-card bg-white rounded-2xl shadow-sm border border-orange-100 p-5 card-hover">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-[10px] font-black text-orange-500 uppercase tracking-wider">Total Analisis</p>
                ...
                <div class="stat-card bg-white rounded-2xl shadow-sm border border-orange-100 p-5 card-hover">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-[10px] font-black text-orange-500 uppercase tracking-wider">Status Healthy</p>
                            <p class="text-2xl font-black text-green-600 mt-1">{{ $calculations->where('status', 'HEALTHY')->count() }}</p>
                        </div>
                ...
                <div class="stat-card bg-white rounded-2xl shadow-sm border border-orange-100 p-5 card-hover">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-[10px] font-black text-orange-500 uppercase tracking-wider">Avg. Net Margin</p>
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-orange-100 overflow-hidden fade-in-up">
                <div class="bg-gradient-navy px-6 py-5 flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="font-bold text-white text-base tracking-wide">Daftar Analisis Decision Engine</h3>
                    </div>
                ...
                <div class="overflow-x-auto">
                    @if($calculations->isEmpty())
                        <div class="p-12 text-center empty-state">
                            ...
                            <h3 class="text-lg font-black text-navy-800 mb-2">Belum Ada Analisis</h3>
                            <p class="text-sm text-navy-500 max-w-md mx-auto">Belum ada data analisis yang tersedia. Silakan lakukan analisis kelayakan bisnis terlebih dahulu.</p>
                        </div>
                    @else
                        <table class="w-full text-left text-sm">
                            <thead class="bg-orange-50/70 border-b border-orange-100">
                                <tr class="text-[10px] font-black text-navy-600 uppercase tracking-wider">
                                    ...
                                    <th class="px-6 py-4 text-right">Net Margin</th>
                                ...
                                <tr class="table-row-hover transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <span class="font-bold text-navy-800 block">{{ $calc->product_name }}</span>
                                                <span class="text-[9px] text-navy-400">{{ $calc->created_at->format('d M Y H:i') }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <span class="font-mono font-bold {{ $margin > 25 ? 'text-green-600' : ($margin > 10 ? 'text-orange-600' : 'text-red-600') }}">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="inline-flex items-center gap-1">
                                            <span class="text-xs font-black text-orange-600">{{ $calc->confidence ?? 75 }}%</span>
                                            <div class="w-12 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                                <div class="h-full bg-gradient-orange" style="width: {{ $calc->confidence ?? 75 }}%"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('decisions.show', $calc->id) }}" class="inline-flex items-center gap-1 text-xs font-black text-orange-600 hover:text-orange-700 transition-colors">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-orange-50/30 px-6 py-3 border-t border-orange-100 flex justify-between items-center">
                            ...
                            <div class="flex gap-3 text-[10px] font-bold">
                                <span class="flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-green-500"></span> Healthy</span>
                                <span class="flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-orange-500"></span> Fragile</span>
                ...
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-navy-500">Lakukan analisis kelayakan produk Anda untuk melihat keputusan bisnis yang tepat.</p>
                        </div>
                    </div>
