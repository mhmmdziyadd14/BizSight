                    ...
                    <div class="flex items-center gap-3">
                        <div class="relative w-full sm:w-64 flex items-center">
                            ...
                            <input type="text" id="searchMaterialInput" value="{{ request('search') }}" placeholder="Cari nama, warna, jenis..." 
                                   class="w-full pl-10 pr-8 bg-white dark:bg-navy-900 border border-orange-300 dark:border-orange-500/20 rounded-xl px-4 py-2.5 text-xs font-semibold text-slate-800 dark:text-white placeholder-slate-400 focus:border-orange-500 focus:ring-0 transition-all leading-normal">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                <button type="button" id="clearSearchBtn" class="{{ request('search') ? '' : 'hidden' }} text-slate-400 hover:text-orange-500 transition-colors flex items-center justify-center">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <select id="filterTypeSelect" class="bg-white dark:bg-navy-900 border border-orange-300 dark:border-orange-500/20 rounded-xl px-3 py-2.5 text-xs font-semibold text-slate-800 dark:text-white focus:border-orange-500 focus:ring-0 transition-all leading-normal">
