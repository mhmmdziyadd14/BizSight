...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: var(--font-sans); }
        .logo-text, .logo-text span { font-family: 'Plus Jakarta Sans', sans-serif !important; }
...
@endphp
    ...
    <header class="mobile-header">
        <button @click="mobileMenuOpen = !mobileMenuOpen" class="mobile-menu-btn" aria-label="Toggle Menu">
            <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6h16M4 12h16M4 18h16" stroke-linecap="round" stroke-linejoin="round"/></svg>
        </button>
        <a href="{{ route('welcome') }}" style="display: flex; align-items: center; gap: 8px; text-decoration: none;">
            <span class="logo-text" style="font-size: 16px;">Clarity Labs</span>
        </a>
        <div style="width: 24px;"></div>
    </header>

    <!-- Mobile Drawer Backdrop -->
    <div class="mobile-backdrop" x-show="mobileMenuOpen" @click="mobileMenuOpen = false" x-cloak></div>
...
<div class="app-container">
    ...
    <aside class="sidebar" :class="{ 'mobile-open': mobileMenuOpen }">
        ...
        <a href="{{ route('dashboard') }}" class="nav-link" @click="mobileMenuOpen = false">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
            My Products
        </a>
        <a href="{{ route('products.index') }}" class="nav-link active" @click="mobileMenuOpen = false">
        ...
        <a href="{{ route('dashboard') }}#orders" class="nav-link" @click="mobileMenuOpen = false">
        ...
        <a href="{{ route('dashboard') }}#profile" class="nav-link" @click="mobileMenuOpen = false">
                ...
                <div class="product-card">
                    ...
                    <div class="product-icon">
                        ...
                        @elseif ($product->name === 'Clarity Essentials')
                            <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 3v18h18M18.7 8l-5.1 5.2-2.8-2.7L7 14.3" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        @elseif ($product->name === 'Clarity Full')
                            <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        @else
